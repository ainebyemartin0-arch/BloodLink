...
urlpatterns = [
    ...
    path('register-admin/', views.register_staff, name='register_admin'),
    path('register-admin-success/', views.register_staff_success, name='register_staff_success'),
    path('approve-staff/', views.approve_staff_list, name='approve_staff_list'),
    path('approve-staff/<int:pk>/', views.approve_staff, name='approve_staff'),
    path('reject-staff/<int:pk>/', views.reject_staff, name='reject_staff'),
    path('donors/', views.donor_list, name='donor_list'),
    path('donors/add/', views.donor_add, name='donor_add'),
    path('donors/add-success/', views.donor_add_success, name='donor_add_success'),
