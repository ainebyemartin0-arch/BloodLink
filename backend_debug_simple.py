#!/usr/bin/env python
"""
Simple Backend Debug Script for BloodLink System
Tests all backend components without Unicode characters
"""
...
def main():
    """Main function"""
    debugger = SimpleBackendDebugger()
